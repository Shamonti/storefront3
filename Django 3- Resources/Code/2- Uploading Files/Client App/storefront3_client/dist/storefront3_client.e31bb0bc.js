    ...
    return _regenerator().w(function (_context) {
      while (1) switch (_context.p = _context.n) {
        ...
        case 3:
          _context.p = 3;
          _t = _context.v;
          if (_t.response) alert(_t.response.data.image[0], 'danger');else if (_t.request) alert('Could not reach the server!', 'danger');else alert('An unexpected error occurred!', 'danger');
        case 4:
